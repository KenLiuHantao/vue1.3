...
export default Vue.extend({
    ...
    "<span v-if='model.edit' @click='cancelchange' class='leftcancel icon-modal__close'></span>" +
    "<input v-if='treeconfig.leftradio && !haschild' @click='choiceradio' type='radio' class='leftradio' name='radio'>" +
    "<span v-on:click.stop='choose(model)'  class='treename' v-bind:class='{activeItem:(activestatus || checked)}'  v-show='!model.edit'>{{model.name}}</span>" +
    ...
    "<button @click='choicedata' v-if='treeconfig.rightchoicebutton && !haschild && !model.edit' class='btn-md-imp rightchoicebutton'>选择</button>" +
    ...
    computed: {
        ...
        activestatus:function(){
            ...
            if(this.model.code===this.activecode){
                return true
            }else{
                return false
            }
    ...
    methods:{
        ...
        toggle:function(){
            if(this.open){
                this.open=false;
                if(this.model.open){
                    this.$dispatch('closeTree',this.model.code)
                }
            }else{
                this.open=true
            }
