        ...
        methods:{
            getCateData(){
               let param = {
                 ...
                 this.$http.post(__URL.sale + 'salesDispatch/findRefCustomerCategory',param).then(
                 res=>{
                       if(res.data.success){
            ...
            getTableData(item,index){
                ...
                this.$http.post(__URL.sale + 'salesDispatch/findRef',param).then(
                    res=>{
                       if(res.data.success){
            ...
            <div class="left-wrap">
                <div class="common-head ">
                    ...
                    <div class="search-input">
                        <input type="text" placeholder="客户/业务员/发退货单号/客户订单号" v-model="keyWord" @keyup.enter="searchData">
                ...
                <ul class="left-content modal-ul">
                   <!-- <li @click="getTableData('',-1)" :class="{'active':currentUl == -1}">
                    ...
                    <li v-for="item in cateData" :class="{'active':currentUl == $index}" @click="getTableData(item.customerCategoryCode,$index)">
            ...
            <div class="right-wrap">
                ...
                <div class="left-content">
                    <table class="modal-table">
                        ...
                        <tr>
                            <th width="10%"></th>
                            <th width="20%" class="text-left">发/退货单号</th>
                            <th width="15%">业务员</th>
                            <th width="15%">货品信息</th>
                            <th width="10%">数量</th>
                            <th width="15%">含税价格</th>
                            <th width="15%">发/退货日期</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr v-for="item in tableData" @click="checkThisLine(item)">
                            ...
                            <td class="text-left">
                                <a @click.stop="" href="javascript:;">{{item.inventoryCode}}</a>
                            </td>
