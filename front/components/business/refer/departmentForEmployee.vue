    ...
    export default {
        ...
        methods:{
            ...
            getInitData() {
                ...
                this.$http.post(__URL.service+'department/find-by-role-code','',{'params': param}).then(
                    (res) => {
            ...
            sure() {
                ...
                this.chooseInfo.departmentCode=this.chooseInfo.code
                this.chooseInfo.departmentName=this.chooseInfo.name
            ...
            config:{
                 handler: function (val, oldVal) {
                    ...
                    if(val.show == true && this.config && this.config.data){
                            this.chooseArr = this.config.data.departmentCode
                    }
                 },
                 deep: true
            },
