<script>
    export default {
        ...
        methods: {
            ...
            doCloseOrder() {
                this.$http.get(__URL.purchase + 'order/close/' + this.docno).then((res) => {
                    if(res.data.success) {
...
<template>
    ...
    <div class="inner-footer">
        ...
        <!--<button v-if="tableData.header.docStatus == 1" @click='completeOrder' class="btn-xl-imp">手动完结订单</button>-->
    </div>

    <!--弹出-->
    <alert :config="alertCfg" @cb="doCloseOrder"></alert>
