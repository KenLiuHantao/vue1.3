...
export default {
    ...
    methods: {
        ...
        getFilter(item,obj) {
            if(obj && obj.saleOrderDocNo){
                item.saleOrderDocNo = obj.saleOrderDocNo;
            }
        ...
        /* 数据请求 */
        getList(obj) {
            var url = __URL.purchase + 'outsource/change/await/query/list';
            switch(cfg.leftItemCfg.tabCfg.select) {
                case 'tab1':
                    url = __URL.purchase + 'outsource/change/await/query/list';
                    break;
                case 'tab2':
                    url = __URL.purchase + 'outsource/change/query/list';
                    break;
            }
