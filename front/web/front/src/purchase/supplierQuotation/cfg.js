        ...
        tabCfg: {
            ...
            tabBarData: [{
                ...
                params: {
                    main: {
                        key: 'yearWeek',
                        url: __URL.purchase + 'supplier/quotation/query/weeks/draft',
                        words: {
                    ...
                    sub: {
                        key: 'supplierCode',
                        url: __URL.purchase + 'supplier/quotation/query/suppliers/draft',
                        words: {
                            title: ['supplierName'],
                            right:'count',
                            sub: []
                ...
                params: {
                    main: {
                        key: 'yearWeek',
                        url: __URL.purchase + 'supplier/quotation/query/weeks/reject',
                        words: {
                            title: ['week', '(', 'weekBeginDate', ' ~ ', 'weekEndDate', ')'],
                            right:'count',
                            sub: []
                    ...
                    sub: {
                        key: 'supplierCode',
                        url: __URL.purchase + 'supplier/quotation/query/suppliers/reject',
                        words: {
                            title: ['supplierName'],
                            right:'count',
                            sub: []
