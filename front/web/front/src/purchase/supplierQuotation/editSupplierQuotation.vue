        ...
        methods: {
            ...
            doSelectCurrency() {
                for(var i = 0; i < this.currencyData.length; i++) {
                    if(this.currencyData[i].currencyCode == this.tableData.header.currencyCode) {
                        this.tableData.header.currencyCode = this.currencyData[i].currencyCode;
                        this.tableData.header.currencyName = this.currencyData[i].currencyName;
                    }
                }
            },
            save() {
                if(!this.lock) {
                    ...
                    if(!this.tableData.header.images) {
                        this.tableData.header.images = [];
                    }
            ...
            <h2 class="tag two-tag"><label>供应商报价单</label><label class="ft-14">报价单号: {{docno}}</label></h2>
                ...
                <div class="inner-item form-box">
                    ...
                    <div class="form-group">
                        ...
                        <select v-model='tableData.header.currencyCode' @change="doSelectCurrency()">
