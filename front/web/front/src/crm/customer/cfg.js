            ...
            tabBarData: [{
                ...
                params: {
                    main: {
                        ...
                        url: __URL.osiu + 'customer/regionLocation/list',
                        words: {
                    ...
                    sub: {
                        ...
                        url: __URL.osiu + 'customer/importanceRating/list',
                        words: {
                ...
                params: {
                    main: {
                        key: 'regionCategoryCode',
                        url: __URL.crm + 'customer/regionLocation/all',
                        words: {
                            title: ['regionCategoryName'],
                            right: 'count',
                            sub: []
                    ...
                    sub: {
                        key: 'importanceRatingCode',
                        url: __URL.crm + 'customer/importanceRating/all',
                        words: {
                            title: ['importanceRatingName'],
                            right: 'count',
                            sub: []
