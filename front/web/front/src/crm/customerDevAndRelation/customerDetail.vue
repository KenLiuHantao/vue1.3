...
<template>
        ...
        <div class="inner-content" v-show='edit==true'>
            ...
            <div class="inner-item form-box">
                ...
                <div class="form-group">
                    ...
                    <div class="s-input ic2 flex">
                        <div class="s-input ic2">
                            <select v-model="newCustomer.regionCategoryCode" @change="getLocation">
                                <option :value='item.code' v-for="item in selectDate">{{item.name}}</option>
                            </select>
                        </div>
                        <div class="s-input ic2">
                            <select v-model="newCustomer.regionLocationCode">
                    ...
                    <tab-item id='tab1'>
                        <table class='inner-table mt-15'>
                            ...
                            <tr v-for='item in newCustomer.contacts'>
                                ...
                                <td>
                                    <button @click='deleteContact($index)' class="button-danger">删除</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <tab-item id='tab2'>
                        <table class='inner-table mt-15'>
                            ...
                            <tr v-for='item in newCustomer.addresses'>
                                ...
                                <td>
                                    <button @click='deleteAddress($index)' class="button-danger">删除</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <div class="inner-footer">
        ...
        <button v-if='edit==false && disabled==false' @click="cancel" class="btn-xl-def">取消</button>
