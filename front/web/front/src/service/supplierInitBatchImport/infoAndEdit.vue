...
<template>
    <div class="form-modal">
        ...
        <div class="form-group">
            ...
            <div class="s-input">
            <input v-if="edit"  type="text"  v-model="data.supplierName" placeholder="输入供应商名称">
            <p  v-else >{{data.supplierName}}</p>
            </div>
        </div>
        <div class="form-group">
            <label></span>联系人:</label>
            <div class="s-input">
