...
<template>
            ...
            <div class="block">
                <div class="form-box inner-item">
                    ...
                    <div class="form-group">
                        ...
                        <!--<input v-if='edit === 1' type="text" v-model='codeInitItem.inventoryCode'>-->
                        <p v-else>{{codeInitItem.inventoryCode}}</p>
                    </div>
                    <div class="form-group">
                        <label><!--<span v-if="edit === 1" class="must-point">*</span>-->货品名称:</label>
                        <!--<input v-if='edit === 1' type="text" v-model='codeInitItem.inventoryName'>-->
                    ...
                    <div class="form-group">
                        ...
                        <!--<div class="s-input ic2"  v-if='edit === 1'>
                            ...
                            <i @click='clearInvent' v-show='codeInitItem.secondInventoryCategoryName' class="icon-modal__close r2" ></i>
                    ...
                    <div class="form-group">
                        ...
                        <!--<select v-if='edit === 1' v-model="codeInitItem.inventoryTypeName" placeholder="请选择类别">
                            <option v-for="item in typeData" :value="item.inventoryTypeName">{{item.inventoryTypeName}}</option>
                        </select>-->
                ...
                <div class="uploadBox inner-item">
                    <div class="form-group wd-100">
                        <label>上传附件:</label>
                        <upfile-group :data='codeInitItem.files' :edit="false"></upfile-group>
                    </div>
                    <div class="form-group wd-100">
                        <label>上传图片:</label>
                        <upfile-group :data='codeInitItem.images' :edit="false"></upfile-group>
                    </div>
                    <div class="form-group">
                        <label>备注:</label>
                ...
                <div class="tabBox inner-item">
                    ...
                    <tab-container :active.sync='tabConfig.select'>
                        <tab-item id='tab1'>
                            <dev :data.sync='codeInitItem.developmentVo' :edit='false'></dev>
                        </tab-item>
                        <tab-item id='tab2'>
                            <sale :data.sync='codeInitItem.customerVos' :edit='false'></sale>
                        </tab-item>
                        <tab-item id='tab3'>
                            <purchase :data.sync='codeInitItem.supplierVos' :edit='false'></purchase>
                        </tab-item>
                    </tab-container>
                </div>
            </div>
    ...
    <div class="inner-footer">
        <button class="btn-xl-def" v-if="edit == 2" @click='cancel'>取消</button>
        <button class="btn-xl-def" v-else @click='cancel'>关闭</button>
        <ajax-button class="btn-xl-danger" v-if="edit == 2" @click='disable'>停用</ajax-button>
    ...
    <alert :config='alertCfg' @cb='sureDisable'></alert>
</template>
