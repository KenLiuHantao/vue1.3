...
<template>
            ...
            <div class="block">
                ...
                <div class=" inner-item">
                    <div class="form-group wd-100">
                        <label>附件:</label>
                        <div class='annexBox'>
                            <upfile-group :data='bomDetail.orderFiles' :edit="false"></upfile-group>
                        </div>
                    </div>
                    <div class="form-group wd-100 align-items__baseline">
                        <label>备注:</label>
                        <p class="lh-20">{{bomDetail.orderRemark}}</p>
                    </div>
                </div>
                <div class='bomTree'>   
    ...
    <div class="inner-footer">
        ...
        <ajax-button class="btn-xl-imp" v-if='bomDetail.workFlowStatus== 20' @click='audit'>审核</ajax-button>
    </div>
