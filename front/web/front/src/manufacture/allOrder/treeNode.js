...
export default Vue.extend({
    ...
    '  </li>' +
    '  <li class="bodyHead">' +
    '      <div class="wd1" style="width:3%" >序号</div>' +
    '      <div class="wd1">' +
    '          <span>货品信息</span>' +
    '      </div>' +
    ...
    '          <span v-if="status == 0">可用量</span>' +
    '          <span v-else="status > 0 ">领料数量</span>' +
    '      </div>' +
    '  </li>' +
    ...
    '      </div>' +
    '      <div class="wd1" style="width:12%" >' +
    '          <div class="itemGroup" v-if="status == 0">' +
    '              <label >{{item.usableQuantity}}</label>' +
    '          </div>' +
    '          <div class="itemGroup" v-else="status > 0">' +
