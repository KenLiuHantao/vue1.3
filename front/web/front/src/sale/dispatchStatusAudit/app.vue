...
export default {
    ...
    methods: {
        ...
        //待审核列表
        getUnAuditList(obj){
              this.$http.post(__URL.sale + 'salesDispatch/findWaitAuditList', obj).then(
                    (res) => {
...
<template>
    ...
    <inner :config='dispatchDocCfg'>
        <dispatch-doc  :dispatch-detail="dispatchDocDetail" @refresh='closeDispatchDoc' :show.sync="dispatchDocCfg.show"></dispatch-doc>
    </inner>
