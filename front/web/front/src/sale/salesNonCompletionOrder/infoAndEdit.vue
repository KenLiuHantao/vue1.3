...
<template>
            ...
            <div class="inner-item-wraper">
                ...
                <div class="inner-contents">
                    <div class="content-item row-info">
                        <img class="img" :src="infoModal.mainVo.imageUrl || noImg">
        ...
        <div class="page-list">
            <div class="item">
                <slot v-if="infoModal.beforeVo != ''">
                    ...
                    <div class="show-item">
                        <div class="show-img">
                            <img :src="infoModal.mainVo.imageUrl || noImg" class="img">
                        </div>
                        <div class="show-info">
    ...
    <div class="inner-footer" style="height: 60px" v-else>
        <button class="btn-xl-def" v-else @click="config.show = false">关闭</button>
    </div>
