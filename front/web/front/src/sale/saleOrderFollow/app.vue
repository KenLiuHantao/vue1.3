...
export default {
    ...
    methods: {
        getList(param,subParam) {
            ...
            let url = 'salesOrderFollowing/findNonCompletionList';
            switch(this.leftItemCfg.tabCfg.select){
                case 'inbound':
                    url = 'salesOrderFollowing/findInboundList';
                    break;
                case 'dispatching':
                    url = 'salesOrderFollowing/findDispatchingList';
                    break;
                case 'dispatched':
                    url = 'salesOrderFollowing/findDoneDispatchList';
                    break;
            }
