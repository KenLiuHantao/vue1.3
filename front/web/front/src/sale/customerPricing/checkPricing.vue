                     ...
                     for(let i=0,l=this.tableConfig.length;i<l;i++){
                        ...
                        if(!this.tableConfig[i].taxRate || this.tableConfig[i].taxRate < 0){
                            ...
                            return false
                             ...
                             if(this.tableConfig[i].taxRate >100){
                            this.wCfg.content = '表单第'+(i+1)+'行的税率不在数据范围内'
                            return false
                          }
...
<template  :config='modalCfg'>
    ...
    <!--<inner :config='modalCfg'>-->
            ...
            <div class="inner-content">
                ...
                <div class="inner-item mt-15">
                    ...
                    <div v-if="formEdit" class="form-group wd-100">
                        <label>备注:</label>
                        <textarea v-model="newPricingHeader.remark"></textarea>
                    </div>
                        ...
                        <tab-item id='contactsTab'>
                            <table class="inner-table mt-15">
                                ...
                                <template v-if="formEdit">
                                    ...
                                    <td>
                                        <input type="number" v-model="item.taxRate" placeholder="税率">
                                    </td>
                                    <td>
                                        <input type="number" v-model="item.lowerLimit" placeholder="从"><br>
                                        <input type="number" v-model="item.upperLimit" placeholder="到">
                                    </td>
                                    <td>
        ...
        <div class="inner-footer">
            ...
            <ajax-button class="btn-xl-imp" @click="saveData"  v-if="formEdit &&  newPricingHeader.audit != 1 " >提交审核</ajax-button>
            <!--<button class="btn-xl-imp" @click="audit"  v-if="newPricingHeader.audit == 0 "  >审核</button>-->
            <!--<button class="btn-xl-imp" @click="refusal"  v-if="newPricingHeader.audit == 0 " >驳回</button>-->
        </div>
    <!--</inner>-->
