...
<template>
    ...
    <div class="inner-footer">
        <button v-if="this.showbutn == 1" @click='config.show = false' class="btn-xl-def">取消</button>
        <button v-else @click='config.show = false' class="btn-xl-def">关闭</button>
        <button v-if="this.showbutn == 1" @click="qualityCheck" class="btn-xl-imp">品检</button>
    </div>
</template>
