<script>
    ...
    export default {
        ...
        ready() {
            this.$http.get(__URL.warehouse + 'quality/check/query/one/' + this.docno, {}).then((res) => {
...
<template>
    <div class="inner-wrapper">
        <div class="inner-content">
            <h2 class="tag two-tag"><label>委外品质检验单信息</label><label class="ft-14">委外品质检验单号: {{ docno }}</label></h2>
            <div class="block">
