<script>
    export default {
        ...
        ready() {
            this.$http.get(__URL.warehouse + 'material/prepare/query/one/' + this.docno, {}).then((res) => {
...
<template>
    <div class="inner-wrapper">
        <div class="inner-content">
            <h2 class="tag two-tag"><label>生产备料单信息</label><label class="ft-14">生产备料单号: {{ docno }}</label></h2>
            <div class="block">
                        ...
                        <tab-item>
                            <table class='inner-table'>
                                ...
                                <tr v-for='item in tableData.dataList'>
                                    ...
                                    <td>{{ item.totalPickingQuantity }}</td>
                                    <td>{{ item.quantity }}</td>
