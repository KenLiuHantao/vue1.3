<script>
    ...
    export default {
        ...
        ready() {
            this.$http.post(__URL.warehouse + 'osc/material/prepare/query/selected', this.checks).then((res) => {
        ...
        methods: {
            save() {
                if(!this.lock) {
                    this.lock = true;
                    this.$http.post(__URL.warehouse + 'osc/material/prepare/save', this.tableData).then((res) => {
            ...
            <div class="block">
                <div class="inner-item form-box">
                    ...
                    <div class="form-group">
                        ...
                        <i class="error" v-show='validShow.docDate'>委外备料日期不能为空</i>
                    </div>
                    <div class="form-group">
                        <label>仓库:</label>
