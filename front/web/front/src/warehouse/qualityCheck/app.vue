    ...
    methods: {
        ...
        getList(obj) {
            ...
            switch(cfg.leftItemCfg.tabCfg.select) {
                case 'tab1':
                    url = __URL.warehouse + 'wait/receive/query/list/for/purchase';
                    break;
                case 'tab2':
                    url = __URL.warehouse + 'receive/query/list/for/purchase';
                    break;
                case 'tab3':
                    url = __URL.warehouse + 'quality/check/query/list/for/qc';
                    break;
                case 'tab4':
                    url = __URL.warehouse + 'wait/return/receive/query/list/for/purchase';
                    break;
            }
