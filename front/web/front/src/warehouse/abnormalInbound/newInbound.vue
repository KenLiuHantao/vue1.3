    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                if(!this.lock) {
                    this.lock=true;
                    this.$http.post(__URL.warehouse + 'abnormal/inbound/save', this.tableData).then( (res) => {
                        if(res.data.success) {
...
<template :config='config'>
    <div class="inner-wrapper">
        <div class="inner-content">
            <h2 class="tag two-tag"><label>新增非正常入库单</label><label></label></h2>
            ...
            <div class="block">
                ...
                <div class="inner-item form-box">
                    ...
                    <div class="form-group">
                        <label><span class="must-point">*</span>入库日期:</label>
                        ...
                        <tab-item>
                            <table class="inner-table">
                                ...
                                <tr>
                                    ...
                                    <th width="10%"><span class="must-point">*</span>入库数量</th>
                                    <th width="10%">单位</th>
                                    <th width="10%">换算率</th>
                                    <th width="10%">辅单位</th>
                                    <th width="10%">辅数量</th>
