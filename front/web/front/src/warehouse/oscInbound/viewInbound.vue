<script>
    export default {
        ...
        ready() {
            this.$http.get(__URL.warehouse + 'osc/inbound/query/one/' + this.docno, {}).then((res) => {
...
<template>
    <div class="inner-wrapper">
        <div class="inner-content">
            <div class="cont">
                <h2 class="tag two-tag"><label>委外入库单信息</label><label class="ft-14">委外入库单号: {{ docno }}</label></h2>
                <div class="block">
