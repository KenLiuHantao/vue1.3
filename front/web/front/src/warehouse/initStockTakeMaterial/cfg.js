            ...
            tabBarData: [
                {
                    ...
                    params: {
                        main: {
                            key: 'warehouseCode',
                            url: __URL.warehouse + 'init/stock/take/material/query/warehouse/category/audit',
                            words: {
                                title: ['warehouseName'],
                                right: 'total',
                                sub: []
                        ...
                        sub: {
                            ...
                            url: __URL.warehouse + 'init/stock/take/material/query/inventory/category/audit',
                            words: {
