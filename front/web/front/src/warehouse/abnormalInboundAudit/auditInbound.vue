    ...
    export default {
        ...
        methods: {
            ...
            reject() {
                if(!this.lock) {
                    this.lock = true;
                    this.$http.post(__URL.warehouse + 'abnormal/inbound/reject', this.buildData()).then( (res) => {
                        if(res.data.success) {
            ...
            audit() {
                if(!this.lock) {
                    this.lock = true;
                    this.$http.post(__URL.warehouse + 'abnormal/inbound/audit/1', this.buildData()).then( (res) => {
                        if(res.data.success) {
