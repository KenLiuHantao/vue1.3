    ...
    export default {
        ...
        methods: {
            ...
            reject() {
                if(!this.lock) {
                    this.lock = true;
                    this.$http.post(__URL.warehouse + 'stock/take/material/reject', this.buildData()).then( (res) => {
                        if(res.data.success) {
            ...
            audit() {
                if(!this.lock) {
                    this.lock = true;
                    this.$http.post(__URL.warehouse + 'stock/take/material/audit/1', this.buildData()).then( (res) => {
                        if(res.data.success) {
