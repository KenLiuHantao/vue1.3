<script>
    ...
    export default {
        ...
        ready(){
            ...
            if (this.detailList.applicationStatus == 1 && this.detailList.rejectStatus == 0) {
        ...
        methods: {
            ...
            auditDimission(param) {
                ...
                this.$http.post(__URL.hr + 'employee/dimission/application/audit', param).then(
                    res => {
                        if (res.data.success) {
...
<template>
    ...
    <div class="inner-footer">
        <button class="btn-xl-def" @click="show=false" v-if="applicationStatus == 1">取消</button>
        <button class="btn-xl-def" @click="show=false" v-else>关闭</button>
        <ajax-button class="btn-xl-def" @click="rejectOpinionModCfg.show=true" v-if="applicationStatus == 1">驳回</ajax-button>
        <ajax-button class="btn-xl-imp" @click="auditOpinionModCfg.show=true" v-if="applicationStatus == 1">通过</ajax-button>
