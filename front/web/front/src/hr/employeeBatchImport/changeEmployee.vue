    ...
    <div class="inner-wrapper">
        ...
        <div class="inner-content">
            ...
            <div class="inner-item form-box">
                ...
                <div class="form-group wd-100" v-if="detail.viceRole.length>0">
                    <label>兼任岗位:</label>
                    <div class="flex">
                        <div v-for="item in detail.viceRole">
                ...
                <div class="inner-item">
                    ...
                    <tab-container :active.sync='tabConfig.select'>
                        <tab-item id='tab1'>
                            ...
                            <div v-show="newEmployee.employeeContracts.length < 1 && isEdit" class="add-wrap">
