...
//                    no:'1',
//                    name:'新增人事档案',
//                    time:this.employeeDetail.createTime,
//                    filed:'',
//                    user:'',
//                    flag:true,
//                },{
...
<template>
    <div class="inner-wrapper">
        ...
        <div class="inner-content">
            ...
            <div class="inner-item form-box">
                ...
                <div class="inner-item" v-if="isEdit">
                            ...
                            <table class='inner-table mt-15'>
                                ...
                                <tbody>
                                    <tr  v-for='(index1,item) in newEmployee.employeeContracts'>
                                        ...
                                        <td>
                                            <button v-show='item.contractStatus==1' class="button-danger" @click='deleteEmployeeContract(index1)'>删除</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <div class="inner-footer">
        <button class="btn-xl-def" @click='cancel' v-if="employeeDetail.working == 0">关闭</button>
        <button class="btn-xl-def" @click='cancel' v-if="employeeDetail.working == 1">取消</button>
        <button class="btn-xl-imp" @click='setEdit' v-if="!isEdit && employeeDetail.working == 1">编辑</button>
