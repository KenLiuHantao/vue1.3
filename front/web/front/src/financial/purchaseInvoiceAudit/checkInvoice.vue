<script>
    export default{
        ...
        methods: {
            ...
            setFlow(){
                var index = this.workflow == null ? 0 : this.workflow-1;
            ...
            unAudit(){
                ...
                this.submitVo.recordVersion = this.orders.dataList[0].recordVersion;
                console.log("&&", this.submitVo);
                this.$http.post(__URL.financial + 'purchase/invoice/unaudit', this.submitVo).then(
                    (res) => {
                        if (res.data.success) {
            ...
            agreeRevoke(){
                ...
                this.submitVo.docNo = this.orders.header.docNo;
                this.submitVo.recordVersion = this.orders.dataList[0].recordVersion;
                this.$http.post(__URL.financial + 'purchase/invoice/revoke', this.submitVo).then((res) => {
                        if (res.data.success) {
