    ...
    export default {
        ...
        data() {
            return {
                ...
                isEdit: false,
                capitalTypeListData: [
                    {capitalType: 2, capitalName: "现金投资--股份公司"},
                ],
                currencyListData: '',
        ...
        methods: {
            ...
            check(){
                ...
                if ((this.tableModel.investmentAmount +"").length > 16) {
                    submit = false
                    this.wCfg.content = '股本长度超过限制'
                    return submit
                }
                if ((this.tableModel.paidInCapital +'').length > 16) {
                    submit = false
                    this.wCfg.content = '股本溢价长度超过限制'
                    return submit
                }

                if (this.tableModel.equity <= 0) {
                    submit = false
                    this.wCfg.content = '股本必须大于0'
                    return submit
                }
    ...
    <div class="inner-wrapper">
        ...
        <div class="inner-content">
            ...
            <div class="inner-item form-box">
                ...
                <div class="form-group">
                    <label><span v-if="edit || add" class="must-point">*</span>股本:</label>
                    <input v-if="edit || add" type="number"
                           v-model="tableModel.equity">
                    <p v-else>{{tableModel.equity}}</p>
                </div>
                <div class="form-group">
                    <label><span v-if="edit || add" class="must-point">*</span>股本溢价:</label>
                    <input v-if="edit || add" type="number"
                           v-model="tableModel.equityPremium">
