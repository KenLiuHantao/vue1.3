<script>
    ...
    export default{
        ...
        methods: {
            ...
            repealPush(){
                this.sendData('verify/payable/repeal/', '撤销提交审核成功', this.itemArr[0].docNo)
            },
...
<template>
    ...
    <div class="inner-wrapper">
        ...
        <div class="inner-content">
            ...
            <div class="inner-item">
                <div class="title">入库/退货单详情</div>
                <table class="inner-table">
                    <thead>
                    <tr>
                        <th width="5%">序号</th>
                        <th width="15%">入库/退货单号</th>
                        <th width="10%">货品信息</th>
                        <th width="10%">单位</th>
                        <th width="10%">数量</th>
                        <th width="10%">单价</th>
