...
export default {
    ...
    methods: {
        ...
        operate(type, item) {
            ...
            //审核
            if(type == 'audit') {
                this.$http.post(__URL.financial + 'sales/invoice/audit',{"docNo":docNo,"recordVersion":recordVersion}).then(
                    (res) => {
                        if(res.data.success){
            ...
            //弃审
            if(type == 'unaudit') {
                this.$http.post(__URL.financial + 'sales/invoice/unaudit',{"docNo":docNo,"recordVersion":recordVersion}).then(
                    (res) => {
                        if(res.data.success){
