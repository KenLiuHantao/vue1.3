<script>
    ...
    export default {
        ...
        methods: {
            ...
            getFilter(item,obj) {
                if (obj && obj.depreciationMethodCode != undefined) {
                    item.depreciationMethodCode = obj.depreciationMethodCode;
            ...
            /* 数据请求 */
            getList(obj) {
                this.$http.get(__URL.arc + 'depreciationmethod/find/'+obj.depreciationMethodCode).then(
                    res => {
                        if (res.data.success) {
            ...
            <div class="right_item">
                ...
                <div class="item_body">
                    <table class="table-wrap">
                        ...
                        <tr v-show="listData.depreciationMethodName">
                            <td width="25%">{{listData.depreciationMethodName}}</td>
                            <td width="25%"></td>
                            <td width="25%"></td>
                            <td width="25%"></td>
                        </tr>
