    ...
    methods: {
        ...
        saveCustomer(){
            ...
            // if(flag){
                ...
                // }
                this.ajaxlock=false;
                this.$http.post(__URL.arc + 'customer/add', data).then(
                    (res) => {
                        this.ajaxlock=true;
                        if(res.data.success){
                            // this.show=false;
...
<template>
                ...
                <h2 class="tag">新增客户档案</h2>
                    ...
                    <div class="inner-item">
                        <div class="form-group wd-100">
                            <label>附件:</label>
                            <div class='annexBox'>
                                <a class='img_item' v-for='imgitem in newCustomer.attachments' :href="imgitem.downloadUrl?imgitem.downloadUrl:'javascript:;'">
                                    {{imgitem.fileName}}
                                ...
                                <tbody>
                                    <tr v-for='item in newCustomer.contacts'>
                                        ...
                                        <td>
                                            ...
                                            <select style='width:70px' v-model='item.major' @change='changeMajor($index)'>
 ...
 -->                                         <a @click='deleteContact($index)' class="delete">删除</a>
                                ...
                                <div class="add-wrap" >
                                    <button @click="addContact"><i class="icon icon-product__add" ></i>&nbsp;新增联系人</button>
                                </div>
                            </tab-item>
                        </tab-container>
            </div>
    ...
    <div class="inner-footer">
        ...
        <button @click='saveCustomer' class="btn-xl-imp">保存</button>
    </div>
    <!-- 业务员弹框 start -->
