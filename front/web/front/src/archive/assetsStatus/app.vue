    ...
    export default {
        ...
        methods: {
            ...
            getFilter(item, obj) {
                ...
                if (obj && obj.assetsStatusCode != undefined) {
                    item.assetsStatusCode = obj.assetsStatusCode;
            ...
            /* 数据请求 */
            getList(obj) {
                this.$http.get(__URL.arc + 'assetsstatus/find/'+obj.assetsStatusCode).then(
                    res => {
                        if (res.data.success) {
            ...
            <div class="right_item">
                ...
                <div class="item_body">
                    <table class="table-wrap">
                        ...
                        <tr>
                            <td width="25%">{{listData.assetsStatusName}}</td>
                            <td width="25%">{{listData.dfault}}</td>
                            <td width="25%"></td>
                            <td width="25%"></td>
                        </tr>
                    </table>
